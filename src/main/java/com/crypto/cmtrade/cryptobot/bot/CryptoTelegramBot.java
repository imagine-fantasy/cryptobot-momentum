...
import com.crypto.cmtrade.cryptobot.service.CryptoTrackingSummaryService;
        ...
        if (update.hasMessage() && update.getMessage().hasText()) {
            ...
            switch (messageText) {
                ...
                case "/summary":
                    ...
                    String cryptoCurrentPnlSummary=cryptoTrackingSummaryService.getMostRecent().toString();
                    sendMessage(chatId, "Your daily summary here " +cryptoCurrentPnlSummary);
                    break;
                default:
